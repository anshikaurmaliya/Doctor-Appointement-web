      ...
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
         ...
         <div className='flex items-center gap-2 mt-1 text-gray-600 '>
          ...
          <button className='py-0.5 px-2 border-gray-600 text-xs rounded-full'>{profileData.experience}</button>
         </div>
         {/*.......Doctors About  */ }
         <div>
...

         {
          ...
          :<button onClick={()=>setIsEdit(true)} className='px-4 py-1 border border-blue-600 text-sm rounded-full mt-5 hover:bg-blue-600 hover:text-white transition-all'>Edit</button>
         }
        </div>
      </div>
    </div>
