...
const Appointement = () => {
  ...
  const { doctors, currencySmbol, backendUrl, token, getDoctorsData } = useContext(AppContext);
  ...
  return (
    <div>
      ...
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <button onClick={bookAppointement} className='bg-primary text-white text-sm font-light px-14 py-3 rounded-full my-6'>
          Book an appointment
        </button>
      </div>
